...
star_count_sum = star_count.sum()[1:]
word_dist = star_count[['1STAR', '2STAR' ,'3STAR', '4STAR', '5STAR']]
word_sum = word_dist.sum(axis=1)

star_count1 = star_count.copy()
star_count1['1STAR'] = star_count1['1STAR']/star_count_sum[0]
star_count1['2STAR'] = star_count1['2STAR']/star_count_sum[1]
star_count1['3STAR'] = star_count1['3STAR']/star_count_sum[2]
star_count1['4STAR'] = star_count1['4STAR']/star_count_sum[3]
star_count1['5STAR'] = star_count1['5STAR']/star_count_sum[4]
